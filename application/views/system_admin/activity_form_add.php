        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('activity_backend/add_Activity'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return validateForm()" id="activityForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="file" name="activity_imgs[]" id="activity_imgs" class="form-control" accept="image/jpeg,image/jpg,image/png,image/jfif" multiple onchange="handleMultipleImages(this)">
