            ...
            ?>
                <div class="bg-gray-50 p-6 rounded-xl <?php echo $moduleClass; ?>" data-module-id="<?php echo $module->id; ?>">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Grid แสดงเมนูย่อย -->
                        <div class="menu-grid-<?php echo $module->id; ?> mt-4" <?php echo ($module->id == 3) ? 'style="display: block;"' : 'style="display: none;"'; ?>>
                                ...
                                ?>
                                    <div class="flex items-center space-x-2 p-2 rounded hover:bg-gray-50">
                                        <input type="checkbox" 
                                               ...
                                               <?php echo ($module->id == 3) ? 'checked' : 'disabled'; ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeBackOfficeModule(); // เพิ่มการ initialize Back Office
...
function toggleMenuCheckboxes(moduleId) {
    ...
    if (mainCheckbox.checked) {
        ...
        // สำหรับ Back Office Module (ID = 3) ให้เลือกเมนูย่อยทั้งหมดโดยอัตโนมัติ
        if (moduleId === 3 || moduleId === '3') {
            setTimeout(() => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'เลือกเมนู Back Office ทั้งหมดแล้ว',
        ...
        // สำหรับ Back Office Module แสดงการแจ้งเตือน
        if (moduleId === 3 || moduleId === '3') {
            Swal.fire({
                icon: 'warning',
...
function initializeBackOfficeModule() {
    // ตรวจสอบว่ามี Back Office Module (ID = 3) หรือไม่
