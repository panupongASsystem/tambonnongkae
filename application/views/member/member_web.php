...
?>
    ...
    <tr class="bg-gray-50 text-left">
        ...
        <th class="px-6 py-3 text-gray-600 cursor-pointer hover:bg-gray-100" onclick="sortTable('position')">
            <div class="flex items-center">
                ตำแหน่ง
                <i class="fas fa-sort ml-1 text-gray-400"></i>
            </div>
        </th>
        <th class="px-6 py-3 text-gray-600 cursor-pointer hover:bg-gray-100" onclick="sortTable('type')">
            <div class="flex items-center">
                ประเภทผู้ใช้
                <i class="fas fa-sort ml-1 text-gray-400"></i>
            </div>
        </th>
        <th class="px-6 py-3 text-gray-600 cursor-pointer hover:bg-gray-100" onclick="sortTable('system')">
            <div class="flex items-center">
                ระบบที่เปิด
                <i class="fas fa-sort ml-1 text-gray-400"></i>
            </div>
        </th>
        <th class="px-6 py-3 text-gray-600 cursor-pointer hover:bg-gray-100" onclick="sortTable('date')">
            <div class="flex items-center">
                วันที่สร้าง
                <i class="fas fa-sort ml-1 text-gray-400"></i>
            </div>
        ...
        <th class="px-6 py-3 text-gray-600">สถานะ</th> 
                ...
                <tbody class="divide-y">
                    <?php foreach ($members as $member): ?>
                        <?php if ($user_system == 'super_admin' && $member->m_system == 'system_admin') continue; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <img src="<?php echo base_url('docs/' . (!empty($member->m_img) ? 'img/' . $member->m_img : 'default_user.png')); ?>" 
    ...
    <span class="px-2 py-1 <?php echo get_system_badge_color($member->m_system); ?> rounded-full text-sm inline-block">
                                ...
                                <div class="flex flex-wrap gap-1">
                                    <?php if (!empty($member->system_names)): 
                                        ...
                                        foreach ($system_names as $system): 
                                            if (!empty($system)):
                                    ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo get_system_badge_color($system); ?>">
                                            <?php echo $system; ?>
                                        </span>
                                    <?php 
                                            endif;
    ...
    <div class="toggle-switch-container">
        <label class="toggle-switch">
            <input type="checkbox" 
                   ...
                   data-member-id="<?php echo $member->m_id; ?>"
                   <?php echo ($member->m_status == 1) ? 'checked' : ''; ?>>
...
window.viewMemberDetails = function(member) {
    ...
    const profileImg = member.m_img 
        ? `${site_url}/docs/img/${member.m_img}` 
