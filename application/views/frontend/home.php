...
<script src="https://assystem.co.th/backend/announcements/script/<?php echo get_config_value('domain'); ?>.go.th"></script>
        ...
        <div class="ita-popup-container">
            ...
            <a href="<?php echo $rs->publicize_ita_link; ?>" target="_blank" class="ita-popup-link">
                <img src="<?php echo base_url('docs/img/' . $rs->publicize_ita_img); ?>"
                    alt="ITA Image <?php echo $index + 1; ?>"
                    class="ita-popup-image"
                    loading="lazy">
...
<div class="position-3bg">
        ...
        <div class="crop">
            ...
            <div class="row" style="padding-top: 5px; padding-bottom: 0px; position: relative; z-index: 4; margin-top: 0px; margin-left: -10px;">
                <div class="col-9" style="padding-left: 60px;">
                    <div class="row">
                        <div class="col">
                            <img src="docs/icon-weather.png" alt="">
                        </div>
                        <div class="col-11 font-text-run" style="margin-top: 0px;">
                            <?php foreach ($qWeather as  $weather) { ?>
                                <marquee direction="left" style="width: 1210px; margin-left: -40px;">
                ...
                <div class="col-3" style="width: 350px; margin-top: -18px; margin-left: 40px;">
    ...
    <div class="bg-activity" id="activity">
        ...
        <div class="crop">
            ...
            <div class="row d-flex justify-content-center" style="position: relative; z-index: 5 !important; margin-top: 30px;">
                        ...
                        <?php foreach ($qNews as $news) { ?>
                            <div class="content-news-detail">
                                <a href="<?php echo site_url('Pages/news_detail/' . $news->news_id); ?>">
                                    <div class="row">
                                        <div class="col-8">
                                            <span class="text-news"><img src="docs/icon-public.png">&nbsp;&nbsp;<?= strip_tags($news->news_name); ?></span>
                                        </div>
                                        <div class="col-4">
                        ...
                        <?php foreach ($qOrder as $gw) { ?>
                            <div class="content-news-detail">
                                <a href="<?php echo site_url('Pages/order_detail/' . $gw->order_id); ?>">
                                    <div class="row">
                                        <div class="col-8">
                                            <span class="text-news"><img src="docs/icon-public.png">&nbsp;&nbsp;<?= strip_tags($gw->order_name); ?></span>
                                        </div>
                                        <div class="col-4">
                                            <div class="row" style="margin-left: 170px;">
                                                <div class="col-10">
                        ...
                        <?php foreach ($qAnnounce as $gw) { ?>
                            <div class="content-news2-detail">
                                <a href="<?php echo site_url('Pages/announce_detail/' . $gw->announce_id); ?>">
                                    <div class="row">
                                        <div class="col-8">
                                            <span class="text-news"><img src="docs/icon-public.png">&nbsp;&nbsp;<?= strip_tags($gw->announce_name); ?></span>
                                        </div>
                                        <div class="col-4">
                                            <div class="row" style="margin-left: 170px;">
                                                <div class="col-10">
                                            ...
                                            foreach ($procurement_egp_tbl_w0 as $index => $rs) : ?>
                                                <div class="row mt-1 underline" style="padding-left: 20px;">
                                                    ...
                                                    <div class="col-8" style="margin-left: 0px;">
                                                        <a href="<?php echo $rs['item_url']; ?>" target="_blank" rel="noopener noreferrer">
                                                            <span class="font-dla-2 line-ellipsis-dla-prov2-pm"><?php echo $rs['item_title']; ?></span>
                                                        </a>
                                                    </div>
                                                </div>
                        ...
                        <?php foreach ($qProcurement as $pcm) { ?>
                            <div class="content-news2-detail">
                                <a href="<?php echo site_url('Pages/procurement_detail/' . $pcm->procurement_id); ?>">
                                    <div class="row">
                                        <div class="col-8">
                                            <span class="text-news"><img src="docs/icon-public.png">&nbsp;&nbsp;<?= strip_tags($pcm->procurement_name); ?></span>
                                        </div>
                                        <div class="col-4">
                                            <div class="row" style="margin-left: 170px;">
                                                <div class="col-10">
                                            ...
                                            <a href="<?php echo site_url('Pages/p_reb_detail/' . $anou->p_reb_id); ?>">
                                                <div class="row mt-1">
                                                    <div class="col-3" style="padding-left: 35px;">
                                                        <span class="text-news-time"><img src="docs/icon-news.png">&nbsp;&nbsp;
                                                            <?php
                                                            // ในการใช้งาน setThaiMonth
    ...
    <div id="myDIV3" class="underline" style="padding-top: 1%; position: relative; z-index: 5;">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div id="tabDla2" class="tab-content-dla">
                <div class="news-dla-prov2">
                    <?php if (!empty($rssData)) : ?>
                        ...
                        foreach ($documentsToShow as $index => $document) : ?>
                            <div class="row mt-2 underline" style="padding-left: 20px;">
                                <div class="col-2">
                                    <span class="font-dla-1 line-ellipsis-dla1"><img src="docs/icon-news.png">&nbsp;&nbsp; <?php echo $document['doc_number']; ?> </span>
                                </div>
                ...
                <div class="d-flex justify-content-end" style="margin-top: 10px; margin-left: 0px; color: #707070; font-size: 13px; position: relative; z-index: 5;">
                    <span>หมายเหตุ อ้างอิงแหล่งที่มาจาก กรมส่งเสริมการปกครองส่วนท้องถิ่น
...
<div class="bg-service" id="oss">
    ...
    <div class="text-center text-run-btm-eservice" style="margin-top: 26px; position: relative; z-index: 5;">
        <div class="row">
            ...
            <div class="col-11">
                <marquee>
                    <span class="font-header-service-line">บริการ สะดวก รวดเร็ว เมื่อแจ้งเรื่องผ่าน e-Service โดยมี Line Notify แจ้งเรื่องไปถึงผู้ดูเเลโดยตรง </span>
                </marquee>
            </div>
        </div>
    </div>
    <div class="service-content underline" style="padding-top: 72px; margin-left: 140px; position: relative; z-index: 5;">
        <div class="row">
            <div class="col-5">
                ...
                <div class="container-video-as">
                    <div class="video-service" style="position: relative; z-index: 3; margin-top: 34px; margin-left: 60px;">
                        <?php if (!empty($manual_esv) && $manual_esv->manual_esv_link != "") : ?>
                            ...
                            if (preg_match("/youtu\.be\/|youtube\.com\/watch|youtube\.com\/shorts/", $manual_esv->manual_esv_link)) :
                                ...
                                if (!empty($video_id)) : ?>
                                    <iframe class="video-iframe" width="420" height="239" src="https://www.youtube-nocookie.com/embed/<?= $video_id; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="border-radius: 16px;"></iframe>
                                <?php endif; ?>
                                <?php
                            ...
                            elseif (preg_match("/facebook\.com\/(?:watch\?v=|.*\/videos\/|reel\/)([0-9]+)/", $manual_esv->manual_esv_link, $matches)) :
                                ...
                                if (!empty($fb_video_id)) : ?>
                                    <iframe src="https://www.facebook.com/plugins/video.php?href=https://www.facebook.com/watch?v=<?= $fb_video_id; ?>" width="420" height="239" style="border:none;overflow:hidden;border-radius:16px;" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media" allowfullscreen></iframe>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
...
<div class="bg-statistics">
    ...
    <div class="bg-statistics-2">
        <a href="https://webanalytics.assystem.co.th/stats/<?php echo get_config_value('analytics_key'); ?>" target="_blank" style="text-decoration: none;">
    ...
    <div style="position: relative; z-index: 5;">
        ...
        <div class="link-dla-container d-flex justify-content-center underline">
            <a href="<?php echo $dla_links[5] ?? '#'; ?>" target="_blank">
                <div class="button-link-dla text-center" style="padding-top: 25px !important; padding-left: 30px;">
                    <span class="font-link-dla-detail">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;One Stop Service</span>
                </div>
            </a>
