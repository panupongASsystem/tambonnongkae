                    ...
                    <?php if (!empty($video->video_link)) : ?>
                        ...
                        if (preg_match("/youtu\.be\/|youtube\.com\/watch|youtube\.com\/shorts/", $video->video_link)) :
                            ...
                            if (!empty($video_id)) : ?>
                                <div class="text-center">
                                    <iframe class="video-iframe" width="100%" height="315" src="https://www.youtube-nocookie.com/embed/<?= htmlspecialchars($video_id); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="border-radius: 16px;"></iframe>
                                </div>
                            <?php endif; ?>
                            <?php
                        ...
                        elseif (preg_match("/facebook\.com\/(?:watch\?v=|.*\/videos\/|reel\/)([0-9]+)/", $video->video_link, $matches)) :
                            ...
                            if (!empty($fb_video_id)) : ?>
                                <div class="text-center">
                                    <iframe src="https://www.facebook.com/plugins/video.php?href=https://www.facebook.com/watch?v=<?= htmlspecialchars($fb_video_id); ?>" width="100%" height="315" style="border:none;overflow:hidden;border-radius:16px;" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media" allowfullscreen></iframe>
                                </div>
                            <?php endif; ?>
                        <?php else : ?>
