    ...
    <script>
        ...
        function buildEsvFullAddress() {
            ...
            if (isUserLoggedIn && userInfo) {
                ...
                const province = document.querySelector('select[name="esv_province"]')?.value || '';
                const amphoe = document.querySelector('select[name="esv_amphoe"]')?.value || '';
                const district = document.querySelector('select[name="esv_district"]')?.value || '';
